...
public class ARMarkersPubSubType : Halodi.CDR.TopicDataType<ARMarkers>
{
   ...
   public override void serialize(halodi_msgs.msg.ARMarkers data, MemoryStream stream)
   {
   ...
   public override void deserialize(MemoryStream stream, halodi_msgs.msg.ARMarkers data)
   {
