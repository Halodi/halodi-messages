...
public class ARMarkerPubSubType : Halodi.CDR.TopicDataType<ARMarker>
{
   ...
   public static void read(halodi_msgs.msg.ARMarker data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(halodi_msgs.msg.ARMarker data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(halodi_msgs.msg.ARMarker data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(halodi_msgs.msg.ARMarker data)
   	{
    ...
    public override void CopyTo(halodi_msgs.msg.ARMarker src, halodi_msgs.msg.ARMarker target)
    {
    	Copy(src, target);
    }
