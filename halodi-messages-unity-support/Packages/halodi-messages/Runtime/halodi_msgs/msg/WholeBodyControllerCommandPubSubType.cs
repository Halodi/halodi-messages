...
*
*/
public class WholeBodyControllerCommandPubSubType : Halodi.CDR.TopicDataType<halodi_msgs.msg.WholeBodyControllerCommand>
{
   public override string Name => "halodi_msgs::msg::dds_::WholeBodyControllerCommand_";


   
   public override void serialize(halodi_msgs.msg.WholeBodyControllerCommand data, MemoryStream stream)
   {
   ...
   public override void deserialize(MemoryStream stream, halodi_msgs.msg.WholeBodyControllerCommand data)
   {
