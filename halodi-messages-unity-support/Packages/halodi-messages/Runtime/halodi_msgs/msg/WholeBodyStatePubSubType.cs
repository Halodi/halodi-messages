...
public class WholeBodyStatePubSubType : Halodi.CDR.TopicDataType<WholeBodyState>
{
   ...
   public static void read(halodi_msgs.msg.WholeBodyState data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(halodi_msgs.msg.WholeBodyState data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(halodi_msgs.msg.WholeBodyState data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(halodi_msgs.msg.WholeBodyState data)
   	{
    ...
    public override void CopyTo(halodi_msgs.msg.WholeBodyState src, halodi_msgs.msg.WholeBodyState target)
    {
    	Copy(src, target);
    }
