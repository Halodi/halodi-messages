...
public class DrivingTrajectoryPubSubType : Halodi.CDR.TopicDataType<DrivingTrajectory>
{
   ...
   public static void read(halodi_msgs.msg.DrivingTrajectory data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(halodi_msgs.msg.DrivingTrajectory data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(halodi_msgs.msg.DrivingTrajectory data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(halodi_msgs.msg.DrivingTrajectory data)
   	{
    ...
    public override void CopyTo(halodi_msgs.msg.DrivingTrajectory src, halodi_msgs.msg.DrivingTrajectory target)
    {
    	Copy(src, target);
    }
