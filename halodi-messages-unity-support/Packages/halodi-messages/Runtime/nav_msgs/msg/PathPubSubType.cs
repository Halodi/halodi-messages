...
public class PathPubSubType : Halodi.CDR.TopicDataType<Path>
{
   ...
   public static void read(nav_msgs.msg.Path data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(nav_msgs.msg.Path data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(nav_msgs.msg.Path data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(nav_msgs.msg.Path data)
   	{
    ...
    public override void CopyTo(nav_msgs.msg.Path src, nav_msgs.msg.Path target)
    {
    	Copy(src, target);
    }
