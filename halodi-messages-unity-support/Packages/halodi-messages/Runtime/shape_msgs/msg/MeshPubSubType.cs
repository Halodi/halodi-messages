...
public class MeshPubSubType : Halodi.CDR.TopicDataType<Mesh>
{
   ...
   public static void read(shape_msgs.msg.Mesh data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(shape_msgs.msg.Mesh data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(shape_msgs.msg.Mesh data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(shape_msgs.msg.Mesh data)
   	{
    ...
    public override void CopyTo(shape_msgs.msg.Mesh src, shape_msgs.msg.Mesh target)
    {
    	Copy(src, target);
    }
