...
public class ParameterEventDescriptorsPubSubType : Halodi.CDR.TopicDataType<rcl_interfaces.msg.ParameterEventDescriptors>
{
   ...
   public override void serialize(rcl_interfaces.msg.ParameterEventDescriptors data, MemoryStream stream)
   {
   ...
   public override void deserialize(MemoryStream stream, rcl_interfaces.msg.ParameterEventDescriptors data)
   {
