...
public class ParameterValuePubSubType : Halodi.CDR.TopicDataType<ParameterValue>
{
   ...
   public static void read(rcl_interfaces.msg.ParameterValue data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(rcl_interfaces.msg.ParameterValue data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(rcl_interfaces.msg.ParameterValue data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(rcl_interfaces.msg.ParameterValue data)
   	{
    ...
    public override void CopyTo(rcl_interfaces.msg.ParameterValue src, rcl_interfaces.msg.ParameterValue target)
    {
    	Copy(src, target);
    }
