...
public class MultiDOFJointStatePubSubType : Halodi.CDR.TopicDataType<MultiDOFJointState>
{
   ...
   public static void read(sensor_msgs.msg.MultiDOFJointState data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(sensor_msgs.msg.MultiDOFJointState data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(sensor_msgs.msg.MultiDOFJointState data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(sensor_msgs.msg.MultiDOFJointState data)
   	{
    ...
    public override void CopyTo(sensor_msgs.msg.MultiDOFJointState src, sensor_msgs.msg.MultiDOFJointState target)
    {
    	Copy(src, target);
    }
