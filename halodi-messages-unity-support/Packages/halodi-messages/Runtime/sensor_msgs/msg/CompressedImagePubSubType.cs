...
public class CompressedImagePubSubType : Halodi.CDR.TopicDataType<CompressedImage>
{
   ...
   public static void read(sensor_msgs.msg.CompressedImage data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(sensor_msgs.msg.CompressedImage data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(sensor_msgs.msg.CompressedImage data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(sensor_msgs.msg.CompressedImage data)
   	{
    ...
    public override void CopyTo(sensor_msgs.msg.CompressedImage src, sensor_msgs.msg.CompressedImage target)
    {
    	Copy(src, target);
    }
