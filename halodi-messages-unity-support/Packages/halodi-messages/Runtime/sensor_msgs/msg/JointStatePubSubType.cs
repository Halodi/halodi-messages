...
public class JointStatePubSubType : Halodi.CDR.TopicDataType<JointState>
{
   ...
   public static void read(sensor_msgs.msg.JointState data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(sensor_msgs.msg.JointState data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(sensor_msgs.msg.JointState data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(sensor_msgs.msg.JointState data)
   	{
    ...
    public override void CopyTo(sensor_msgs.msg.JointState src, sensor_msgs.msg.JointState target)
    {
    	Copy(src, target);
    }
