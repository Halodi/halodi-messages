...
public class BatteryStatePubSubType : Halodi.CDR.TopicDataType<BatteryState>
{
   ...
   public static void read(sensor_msgs.msg.BatteryState data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(sensor_msgs.msg.BatteryState data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(sensor_msgs.msg.BatteryState data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(sensor_msgs.msg.BatteryState data)
   	{
    ...
    public override void CopyTo(sensor_msgs.msg.BatteryState src, sensor_msgs.msg.BatteryState target)
    {
    	Copy(src, target);
    }
