...
public class CameraInfoPubSubType : Halodi.CDR.TopicDataType<CameraInfo>
{
   ...
   public static void read(sensor_msgs.msg.CameraInfo data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(sensor_msgs.msg.CameraInfo data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(sensor_msgs.msg.CameraInfo data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(sensor_msgs.msg.CameraInfo data)
   	{
    ...
    public override void CopyTo(sensor_msgs.msg.CameraInfo src, sensor_msgs.msg.CameraInfo target)
    {
    	Copy(src, target);
    }
