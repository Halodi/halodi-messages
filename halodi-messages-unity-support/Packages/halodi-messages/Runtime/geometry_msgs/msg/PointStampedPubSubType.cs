...
public class PointStampedPubSubType : Halodi.CDR.TopicDataType<PointStamped>
{
   ...
   public static void read(geometry_msgs.msg.PointStamped data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(geometry_msgs.msg.PointStamped data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(geometry_msgs.msg.PointStamped data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(geometry_msgs.msg.PointStamped data)
   	{
    ...
    public override void CopyTo(geometry_msgs.msg.PointStamped src, geometry_msgs.msg.PointStamped target)
    {
    	Copy(src, target);
    }
