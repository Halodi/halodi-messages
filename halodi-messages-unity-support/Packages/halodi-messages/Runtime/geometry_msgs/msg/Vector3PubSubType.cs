...
public class Vector3PubSubType : Halodi.CDR.TopicDataType<Vector3>
{
   ...
   public static void read(geometry_msgs.msg.Vector3 data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(geometry_msgs.msg.Vector3 data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(geometry_msgs.msg.Vector3 data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(geometry_msgs.msg.Vector3 data)
   	{
    ...
    public override void CopyTo(geometry_msgs.msg.Vector3 src, geometry_msgs.msg.Vector3 target)
    {
    	Copy(src, target);
    }
