...
*
*/
public class PoseArrayPubSubType : Halodi.CDR.TopicDataType<PoseArray>
{
   ...
   public static void read(geometry_msgs.msg.PoseArray data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(geometry_msgs.msg.PoseArray data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(geometry_msgs.msg.PoseArray data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(geometry_msgs.msg.PoseArray data)
   	{
    ...
    public override void CopyTo(geometry_msgs.msg.PoseArray src, geometry_msgs.msg.PoseArray target)
    {
    	Copy(src, target);
    }
