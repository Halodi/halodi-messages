...
*
*/
public class JointTrajectoryPointPubSubType : Halodi.CDR.TopicDataType<JointTrajectoryPoint>
{
   ...
   public static void read(trajectory_msgs.msg.JointTrajectoryPoint data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(trajectory_msgs.msg.JointTrajectoryPoint data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(trajectory_msgs.msg.JointTrajectoryPoint data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(trajectory_msgs.msg.JointTrajectoryPoint data)
   	{
    ...
    public override void CopyTo(trajectory_msgs.msg.JointTrajectoryPoint src, trajectory_msgs.msg.JointTrajectoryPoint target)
    {
    	Copy(src, target);
    }
