...
public class MultiDOFJointTrajectoryPointPubSubType : Halodi.CDR.TopicDataType<MultiDOFJointTrajectoryPoint>
{
   ...
   public static void read(trajectory_msgs.msg.MultiDOFJointTrajectoryPoint data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(trajectory_msgs.msg.MultiDOFJointTrajectoryPoint data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(trajectory_msgs.msg.MultiDOFJointTrajectoryPoint data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(trajectory_msgs.msg.MultiDOFJointTrajectoryPoint data)
   	{
    ...
    public override void CopyTo(trajectory_msgs.msg.MultiDOFJointTrajectoryPoint src, trajectory_msgs.msg.MultiDOFJointTrajectoryPoint target)
    {
    	Copy(src, target);
    }
