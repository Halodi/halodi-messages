...
public class ModeSchedulePubSubType : Halodi.CDR.TopicDataType<ModeSchedule>
{
   ...
   public static void read(ocs2_ros2_msgs.msg.ModeSchedule data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(ocs2_ros2_msgs.msg.ModeSchedule data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(ocs2_ros2_msgs.msg.ModeSchedule data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(ocs2_ros2_msgs.msg.ModeSchedule data)
   	{
    ...
    public override void CopyTo(ocs2_ros2_msgs.msg.ModeSchedule src, ocs2_ros2_msgs.msg.ModeSchedule target)
    {
    	Copy(src, target);
    }
