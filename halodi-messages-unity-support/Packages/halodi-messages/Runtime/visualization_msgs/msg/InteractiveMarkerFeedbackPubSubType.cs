...
public class InteractiveMarkerFeedbackPubSubType : Halodi.CDR.TopicDataType<InteractiveMarkerFeedback>
{
   ...
   public static void read(visualization_msgs.msg.InteractiveMarkerFeedback data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(visualization_msgs.msg.InteractiveMarkerFeedback data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(visualization_msgs.msg.InteractiveMarkerFeedback data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(visualization_msgs.msg.InteractiveMarkerFeedback data)
   	{
    ...
    public override void CopyTo(visualization_msgs.msg.InteractiveMarkerFeedback src, visualization_msgs.msg.InteractiveMarkerFeedback target)
    {
    	Copy(src, target);
    }
