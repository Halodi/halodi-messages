...
public class MarkerPubSubType : Halodi.CDR.TopicDataType<Marker>
{
   ...
   public override void serialize(visualization_msgs.msg.Marker data, MemoryStream stream)
   {
   ...
   public override void deserialize(MemoryStream stream, visualization_msgs.msg.Marker data)
   {
