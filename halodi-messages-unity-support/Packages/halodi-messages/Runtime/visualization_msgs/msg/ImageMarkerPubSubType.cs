...
*
*/
public class ImageMarkerPubSubType : Halodi.CDR.TopicDataType<ImageMarker>
{
   ...
   public static void read(visualization_msgs.msg.ImageMarker data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(visualization_msgs.msg.ImageMarker data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(visualization_msgs.msg.ImageMarker data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(visualization_msgs.msg.ImageMarker data)
   	{
    ...
    public override void CopyTo(visualization_msgs.msg.ImageMarker src, visualization_msgs.msg.ImageMarker target)
    {
    	Copy(src, target);
    }
