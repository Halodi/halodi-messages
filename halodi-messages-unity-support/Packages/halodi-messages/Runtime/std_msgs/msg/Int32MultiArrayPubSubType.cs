...
public class Int32MultiArrayPubSubType : Halodi.CDR.TopicDataType<std_msgs.msg.Int32MultiArray>
{
   ...
   public override void serialize(std_msgs.msg.Int32MultiArray data, MemoryStream stream)
   {
   ...
   public override void deserialize(MemoryStream stream, std_msgs.msg.Int32MultiArray data)
   {
