...
public class UInt8MultiArrayPubSubType : Halodi.CDR.TopicDataType<UInt8MultiArray>
{
   ...
   public static void read(std_msgs.msg.UInt8MultiArray data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(std_msgs.msg.UInt8MultiArray data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(std_msgs.msg.UInt8MultiArray data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(std_msgs.msg.UInt8MultiArray data)
   	{
    ...
    public override void CopyTo(std_msgs.msg.UInt8MultiArray src, std_msgs.msg.UInt8MultiArray target)
    {
    	Copy(src, target);
    }
