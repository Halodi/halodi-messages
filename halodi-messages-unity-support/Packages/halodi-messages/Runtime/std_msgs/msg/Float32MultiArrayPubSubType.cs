...
/**
* 
* Topic data type of the struct "Float32MultiArray" defined in "Float32MultiArray.idl". Use this class to provide the TopicDataType to a Participant. 
*
* This file was automatically generated from Float32MultiArray.idl by com.halodi.idl.generator.IDLCSharpGenerator. 
* Do not update this file directly, edit Float32MultiArray.idl instead.
*
*/
public class Float32MultiArrayPubSubType : Halodi.CDR.TopicDataType<std_msgs.msg.Float32MultiArray>
{
   ...
   public static int getCdrSerializedSize(std_msgs.msg.Float32MultiArray data, int current_alignment)
   {
   ...
   public static void read(std_msgs.msg.Float32MultiArray data, Halodi.CDR.CDRDeserializer cdr)
   {
