...
*
*/
public class Int8MultiArrayPubSubType : Halodi.CDR.TopicDataType<std_msgs.msg.Int8MultiArray>
{
   public override string Name => "std_msgs::msg::dds_::Int8MultiArray_";


   
   public override void serialize(std_msgs.msg.Int8MultiArray data, MemoryStream stream)
   {
   ...
   public override void deserialize(MemoryStream stream, std_msgs.msg.Int8MultiArray data)
   {
