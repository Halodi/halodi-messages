...
*
*/
public class UInt64PubSubType : Halodi.CDR.TopicDataType<UInt64>
{
   ...
   public static void read(std_msgs.msg.UInt64 data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(std_msgs.msg.UInt64 data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(std_msgs.msg.UInt64 data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(std_msgs.msg.UInt64 data)
   	{
    ...
    public override void CopyTo(std_msgs.msg.UInt64 src, std_msgs.msg.UInt64 target)
    {
    	Copy(src, target);
    }
