...
public class Float64PubSubType : Halodi.CDR.TopicDataType<Float64>
{
   ...
   public static void read(std_msgs.msg.Float64 data, Halodi.CDR.CDRDeserializer cdr)
   {
	...
	public override void Serialize(std_msgs.msg.Float64 data, Halodi.CDR.CDRSerializer cdr)
   	{
   		write(data, cdr);	
   	}

	public override void Deserialize(std_msgs.msg.Float64 data, Halodi.CDR.CDRDeserializer cdr)
   	{
   		read(data, cdr);	
   	}
   	
   	public override int GetSize(std_msgs.msg.Float64 data)
   	{
    ...
    public override void CopyTo(std_msgs.msg.Float64 src, std_msgs.msg.Float64 target)
    {
    	Copy(src, target);
    }
