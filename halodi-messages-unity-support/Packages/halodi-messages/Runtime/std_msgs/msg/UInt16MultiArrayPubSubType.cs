...
public class UInt16MultiArrayPubSubType : Halodi.CDR.TopicDataType<UInt16MultiArray>
{
   ...
   public override void serialize(std_msgs.msg.UInt16MultiArray data, MemoryStream stream)
   {
   ...
   public override void deserialize(MemoryStream stream, std_msgs.msg.UInt16MultiArray data)
   {
