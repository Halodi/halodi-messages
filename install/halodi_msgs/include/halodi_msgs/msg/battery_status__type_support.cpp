...
{
  new (message_memory) halodi_msgs::msg::BatteryStatus(_init);
}

void BatteryStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<halodi_msgs::msg::BatteryStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BatteryStatus_message_member_array[4] = {
  {
    ...
    offsetof(halodi_msgs::msg::BatteryStatus, battery_status_level),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(halodi_msgs::msg::BatteryStatus, battery_voltage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(halodi_msgs::msg::BatteryStatus, low_battery_voltage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(halodi_msgs::msg::BatteryStatus, shutdown_battery_voltage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BatteryStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(halodi_msgs::msg::BatteryStatus),
...
get_message_type_support_handle<halodi_msgs::msg::BatteryStatus>()
{
  return &::halodi_msgs::msg::rosidl_typesupport_introspection_cpp::BatteryStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, halodi_msgs, msg, BatteryStatus)() {
  return &::halodi_msgs::msg::rosidl_typesupport_introspection_cpp::BatteryStatus_message_type_support_handle;
}
