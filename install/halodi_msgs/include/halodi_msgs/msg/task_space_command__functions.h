...
#ifndef HALODI_MSGS__MSG__TASK_SPACE_COMMAND__FUNCTIONS_H_
#define HALODI_MSGS__MSG__TASK_SPACE_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * halodi_msgs__msg__TaskSpaceCommand__init().
...
/**
 * It calls
 * halodi_msgs__msg__TaskSpaceCommand__fini()
 ...
 * halodi_msgs__msg__TaskSpaceCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * halodi_msgs__msg__TaskSpaceCommand__Sequence__fini()
 * on the array,
...
#endif  // HALODI_MSGS__MSG__TASK_SPACE_COMMAND__FUNCTIONS_H_
